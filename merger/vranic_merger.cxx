...
using std::chrono::milliseconds;
    ...
    void V_Merger::merge(part &pp, const int* x_bins, const int* p_bins){    
    ...
    void  V_Merger::p_cartesian(part &pp, const int* x_bins, const int* p_bins,
    ...
    std::tuple<int, int>
    V_Merger::p_reduction(part &pp, const int* p_bins, const double* p_min,
